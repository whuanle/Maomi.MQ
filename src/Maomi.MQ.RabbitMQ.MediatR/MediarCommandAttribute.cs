// <copyright file="MediarCommandAttribute.cs" company="Maomi">
...
public class MediarCommandAttribute : Attribute, IConsumerOptions
{
    /// <inheritdoc />
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="MediarCommandAttribute"/> class.
    /// </summary>
    /// <param name="queue">Queue name.</param>
    public MediarCommandAttribute(string queue)
    {
    ...
    {
        var newOptions = new MediarCommandAttribute(this.Queue);
