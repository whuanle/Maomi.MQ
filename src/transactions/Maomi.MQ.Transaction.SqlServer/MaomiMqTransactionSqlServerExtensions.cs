...
/// <summary>
/// SQL Server transaction extension.
/// </summary>
public static class MaomiMqTransactionSqlServerExtensions
{
    /// <summary>
    /// Registers SQL Server transaction database provider.
    /// </summary>
    /// <param name="services">Service collection.</param>
    /// <returns>Service collection.</returns>
    public static IServiceCollection AddMaomiMQTransactionSqlServer(this IServiceCollection services)
    {
