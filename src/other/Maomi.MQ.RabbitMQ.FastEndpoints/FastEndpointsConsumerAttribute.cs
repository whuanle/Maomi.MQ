// <copyright file="FastEndpointsConsumerAttribute.cs" company="Maomi">
...
public class FastEndpointsConsumerAttribute : Attribute, IConsumerOptions
{
    /// <inheritdoc />
    ...
    public FastEndpointsConsumerAttribute(string queue)
    {
    ...
    {
        FastEndpointsConsumerAttribute newOptions = new(this.Queue);
