...
//    {
//        public TestDefaultConsumerHostService(IServiceProvider serviceProvider, DefaultMqOptions mqOptions, IJsonSerializer jsonSerializer, ILogger<ConsumerHostService<TConsumer, TEvent>> logger, IRetryPolicyFactory policyFactory, IWaitReadyFactory waitReadyFactory) : base(serviceProvider, mqOptions, jsonSerializer, logger, policyFactory, waitReadyFactory)
//        {
//        }
